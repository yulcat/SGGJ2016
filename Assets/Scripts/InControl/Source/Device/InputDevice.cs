namespace InControl
{
    ...
    public class InputDevice
    {
        ...
        void ProcessLeftStick(ulong updateTick, float deltaTime)
        {
            ...
            var y = Utility.ValueFromSides(LeftStickDown.NextRawValue, LeftStickUp.NextRawValue,
                InputManager.InvertYAxis);
            ...
            {
                var lowerDeadZone = Utility.Max(LeftStickLeft.LowerDeadZone, LeftStickRight.LowerDeadZone,
                    LeftStickUp.LowerDeadZone, LeftStickDown.LowerDeadZone);
                var upperDeadZone = Utility.Min(LeftStickLeft.UpperDeadZone, LeftStickRight.UpperDeadZone,
                    LeftStickUp.UpperDeadZone, LeftStickDown.UpperDeadZone);
        ...
        void ProcessRightStick(ulong updateTick, float deltaTime)
        {
            ...
            var y = Utility.ValueFromSides(RightStickDown.NextRawValue, RightStickUp.NextRawValue,
                InputManager.InvertYAxis);
            ...
            {
                var lowerDeadZone = Utility.Max(RightStickLeft.LowerDeadZone, RightStickRight.LowerDeadZone,
                    RightStickUp.LowerDeadZone, RightStickDown.LowerDeadZone);
                var upperDeadZone = Utility.Min(RightStickLeft.UpperDeadZone, RightStickRight.UpperDeadZone,
                    RightStickUp.UpperDeadZone, RightStickDown.UpperDeadZone);
                v = Utility.ApplyCircularDeadZone(x, y, lowerDeadZone, upperDeadZone);
            }
        ...
        void ProcessDPad(ulong updateTick, float deltaTime)
        {
            ...
            {
                var lowerDeadZone = Utility.Max(DPadLeft.LowerDeadZone, DPadRight.LowerDeadZone, DPadUp.LowerDeadZone,
                    DPadDown.LowerDeadZone);
                var upperDeadZone = Utility.Min(DPadLeft.UpperDeadZone, DPadRight.UpperDeadZone, DPadUp.UpperDeadZone,
                    DPadDown.UpperDeadZone);
        ...
        public InputControl RightStickButton
        {
            get
            {
                return cachedRightStickButton ??
                       (cachedRightStickButton = GetControl(InputControlType.RightStickButton));
            }
        }
