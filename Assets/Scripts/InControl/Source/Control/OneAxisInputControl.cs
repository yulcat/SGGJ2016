namespace InControl
{
    ...
    public class OneAxisInputControl : IInputControl
    {
        ...
        void PrepareForUpdate(ulong updateTick)
        {
            ...
            if (pendingCommit && updateTick != pendingTick)
            {
                throw new InvalidOperationException(
                    "Cannot be updated for a new tick until pending tick is committed.");
            }
        ...
        internal void CommitWithSides(InputControl negativeSide, InputControl positiveSide, ulong updateTick,
            float deltaTime)
        {
        ...
        public bool IsNull
        {
            get { return ReferenceEquals(this, InputControl.Null); }
        }
