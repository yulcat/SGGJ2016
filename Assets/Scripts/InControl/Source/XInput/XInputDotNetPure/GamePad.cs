...
namespace XInputDotNetPure
{
    ...
    public struct GamePadState
    {
        ...
        internal GamePadState(bool isConnected, RawState rawState)
        {
            ...
            thumbSticks = new GamePadThumbSticks(
                new GamePadThumbSticks.StickValue(rawState.Gamepad.sThumbLX / (float) short.MaxValue,
                    rawState.Gamepad.sThumbLY / (float) short.MaxValue),
                new GamePadThumbSticks.StickValue(rawState.Gamepad.sThumbRX / (float) short.MaxValue,
                    rawState.Gamepad.sThumbRY / (float) short.MaxValue)
            );

            triggers = new GamePadTriggers(rawState.Gamepad.bLeftTrigger / (float) byte.MaxValue,
                rawState.Gamepad.bRightTrigger / (float) byte.MaxValue);
        }
    ...
    public class GamePad
    {
        public static GamePadState GetState(PlayerIndex playerIndex)
        {
            ...
            var state = (GamePadState.RawState) Marshal.PtrToStructure(gamePadStatePointer,
