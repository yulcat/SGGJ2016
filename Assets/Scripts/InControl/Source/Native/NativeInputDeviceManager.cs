namespace InControl
{
    ...
    {
        public static Func<NativeDeviceInfo, ReadOnlyCollection<NativeInputDevice>, NativeInputDevice>
            CustomFindDetachedDevice;
        ...
        void DetectDevice(DeviceHandle deviceHandle, NativeDeviceInfo deviceInfo)
        {
            ...
            deviceProfile = deviceProfile ??
                            customDeviceProfiles.Find(profile => profile.LastResortMatches(deviceInfo));
            deviceProfile = deviceProfile ??
                            systemDeviceProfiles.Find(profile => profile.LastResortMatches(deviceInfo));
        ...
        static NativeInputDevice SystemFindDetachedDevice(NativeDeviceInfo deviceInfo,
        ...
        public static bool CheckPlatformSupport(ICollection<string> errors)
        {
            ...
            try
            {
                ...
                Logger.LogInfo("InControl Native (version " + versionInfo.major + "." + versionInfo.minor + "." +
                               versionInfo.patch + ")");
            }
            catch (DllNotFoundException e)
            {
                if (errors != null)
                {
                    errors.Add(e.Message + Utility.PluginFileExtension() +
                               " could not be found or is missing a dependency.");
                }
                return false;
            }
