namespace InControl
{
    ...
    {
        [Header("Position")] [SerializeField] TouchUnitType areaUnitType = TouchUnitType.Percent;
        ...
        [Header("Analog Target")] public AnalogTarget target = AnalogTarget.None;
        public SnapAngles snapAngles = SnapAngles.None;


        [Header("Button Targets")] public ButtonTarget upTarget = ButtonTarget.None;
