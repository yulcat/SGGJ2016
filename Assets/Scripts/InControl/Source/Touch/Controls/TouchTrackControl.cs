namespace InControl
{
    ...
    {
        [Header("Dimensions")] [SerializeField] TouchUnitType areaUnitType = TouchUnitType.Percent;

        [SerializeField] Rect activeArea = new Rect(25.0f, 25.0f, 50.0f, 50.0f);


        [Header("Analog Target")] public AnalogTarget target = AnalogTarget.LeftStick;
        public float scale = 1.0f;

        [Header("Button Target")] public ButtonTarget tapTarget = ButtonTarget.None;
