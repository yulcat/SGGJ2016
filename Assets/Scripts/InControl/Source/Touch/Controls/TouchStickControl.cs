namespace InControl
{
    ...
    {
        [Header("Position")] [SerializeField] TouchControlAnchor anchor = TouchControlAnchor.BottomLeft;

        [SerializeField] TouchUnitType offsetUnitType = TouchUnitType.Percent;

        [SerializeField] Vector2 offset = new Vector2(20.0f, 20.0f);

        [SerializeField] TouchUnitType areaUnitType = TouchUnitType.Percent;

        [SerializeField] Rect activeArea = new Rect(0.0f, 0.0f, 50.0f, 100.0f);


        [Header("Options")] public AnalogTarget target = AnalogTarget.LeftStick;
        ...
        [Header("Sprites")] public TouchSprite ring = new TouchSprite(20.0f);
        ...
        {
            get { return ring.Ready ? ring.Position : transform.position; }
        ...
        {
            get { return knob.Ready ? knob.Position : transform.position; }
