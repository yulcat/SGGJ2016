namespace InControl
{
    ...
    public class TouchSprite
    {
        ...
        [SerializeField] Color idleColor = new Color(1.0f, 1.0f, 1.0f, 0.5f);

        [SerializeField] Color busyColor = new Color(1.0f, 1.0f, 1.0f, 1.0f);

        [SerializeField] TouchSpriteShape shape = TouchSpriteShape.Oval;

        [SerializeField] TouchUnitType sizeUnitType = TouchUnitType.Percent;

        [SerializeField] Vector2 size = new Vector2(10.0f, 10.0f);

        [SerializeField] bool lockAspectRatio = true;

        [SerializeField, HideInInspector] Vector2 worldSize;
        ...
        {
            get { return spriteGameObject ? spriteGameObject.transform.position : Vector3.zero; }
