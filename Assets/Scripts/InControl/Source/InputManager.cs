namespace InControl
{
    ...
    public class InputManager
    {
        ...
        [Obsolete(
            "Calling InputManager.Setup() directly is no longer supported. Use the InControlManager component to manage the lifecycle of the input manager instead.",
            true)]
        ...
        /// manage the lifecycle of the input manager instead.
        [Obsolete(
            "Calling InputManager.Reset() method directly is no longer supported. Use the InControlManager component to manage the lifecycle of the input manager instead.",
            true)]
        ...
        /// manage the lifecycle of the input manager instead.
        [Obsolete(
            "Calling InputManager.Update() directly is no longer supported. Use the InControlManager component to manage the lifecycle of the input manager instead.",
            true)]
        ...
        {
            get { return KeyCombo.Detect(true).Count > 0; }
        }
