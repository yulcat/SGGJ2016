...
namespace InControl.Internal
{
    ...
    internal static class EditorUtility
    {
        ...
        static EditorUtility()
        {
            ...
            titleStyle.normal.background = IsProSkin
                ? Internal.EditorTextures.InspectorTitle_Pro
                : Internal.EditorTextures.InspectorTitle;
            ...
            groupStyle.normal.background = IsProSkin
                ? Internal.EditorTextures.InspectorGroup_Pro
                : Internal.EditorTextures.InspectorGroup;
            ...
            wellStyle.normal.background =
                IsProSkin ? Internal.EditorTextures.InspectorWell_Pro : Internal.EditorTextures.InspectorWell;
        ...
        internal static void GroupTitle(string title, SerializedProperty boolProperty)
        {
            ...
            boolProperty.boolValue =
                EditorGUILayout.ToggleLeft("<b>" + title + "</b>", boolProperty.boolValue, labelStyle);
