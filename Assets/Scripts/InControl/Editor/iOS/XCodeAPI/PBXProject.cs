    ...
    public class PBXProject
    {
        ...
        private string AddFileImpl(string path, string projectPath, PBXSourceTree tree)
        {
            ...
            if (guid == null)
            {
                PBXFileReference fileRef =
                    PBXFileReference.CreateFromFile(path, Utils.GetFilenameFromPath(projectPath), tree);
        ...
        */
        ...
        private void SetDefaultAppExtensionReleaseBuildFlags(XCBuildConfiguration config, string infoPlistPath)
        {
            ...
            config.AddProperty("LD_RUNPATH_SEARCH_PATHS",
        ...
        internal string AddAppExtension(string mainTarget, string name, string infoPlistPath)
        {
            ...
            var newTarget = PBXNativeTarget.Create(name, productFileRef.guid, "com.apple.product-type.app-extension",
                buildConfigList.guid);
            ...
            var buildAppCopy =
                PBXBuildFile.CreateFromFile(FindFileGuidByProjectPath("Products/" + fullName), false, "");
        ...
        public void UpdateBuildPropertyForConfig(string configGuid, string name, string[] addValues,
            string[] removeValues)
        {
        ...
        public void UpdateBuildPropertyForConfig(string[] configGuids, string name, string[] addValues,
            string[] removeValues)
        {
            foreach (string guid in configGuids)
