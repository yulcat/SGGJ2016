...
namespace LitJson
{
    ...
    public class JsonException : Exception
    {
        ...
        internal JsonException(ParserToken token, Exception inner) : base(
            string.Format("Invalid token '{0}' in input string", token), inner)
        {
        }
        ...
        internal JsonException(int c, Exception inner) : base(
            string.Format("Invalid character '{0}' in input string", (char) c), inner)
        {
        }
